...
- **Loading:** Automatically loaded by default. To disable AGENTS.md loading, set `"qcode.useAgentRules": false` in your VSCode settings
- **Setting:** `qcode.useAgentRules` (default: true)
