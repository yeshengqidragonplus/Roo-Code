	...
	*/
	...
	async getStateToPostToWebview(): Promise<ExtensionState> {
		...
		return {
			...
			autoCondenseContextMessageCount: autoCondenseContextMessageCount ?? 0,
	...
	> {
		...
		return {
			...
			autoCondenseContextMessageCount: stateValues.autoCondenseContextMessageCount ?? 0,
			...
			autoApprovalMode: stateValues.autoApprovalMode ?? "manual",
			customModes,
			...
			useProjectMemory: stateValues.useProjectMemory ?? true,
			enableSelfReflection: stateValues.enableSelfReflection ?? false,
